//https://bl.ocks.org/HarryStevens/be559bed98d662f69e68fc8a7e0ad097
    ...
    var margin = {top: 5, right: 5, bottom: 20, left: 50},
      ...
      outlierData = data.filter(function(element) {return element.DEATHS > 50});
      console.log(outlierData)
      console.log(data.length)

	    // see below for an explanation of the calcLinear function
	    var lg = calcLinear(data, "x", "y", d3.min(data, function(d){ return d.TEMPERATURE}), d3.max(data, function(d){ return d.TEMPERATURE}));
      var lg2 = calcLinear(outlierData, "x", "y", d3.min(outlierData, function(d){ return d.TEMPERATURE}), d3.max(outlierData, function(d){ return d.TEMPERATURE}));
